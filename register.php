...
<div class="container">
  ...
  <form method="POST" action="process_registration.php">
    ...
    <!-- New fields for mobile number and address -->
    <div class="form-group row">
      <label for="mobile_no" class="col-sm-2 col-form-label text-right">Mobile No</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="Mobile Number">
        <small id="mobileNoHelp" class="form-text text-muted"><span class="text-danger">* Required.</span></small>
      </div>
    </div>
  ...
  <?php
      // Determine the base URL dynamically for the login link
      $login = 'login.php';
